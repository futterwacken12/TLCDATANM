...
namespace CHS.TLC.Data.NM.Web.Controllers
{
    ...
    public class BaseController : Controller
    {
        ...
        private void GenerarMenu(ref StringBuilder sb, Option option, List<RoleOption> LstRoleOption)
        {
            ...
            {
                sb.Append("<li class=''>" +
                            "<a href='" + EncryptedExtensions.EncodedUrl(option.Action, option.Controller, option.Area, new { FatherId = option.OptionId }) + "'><i class='icon-" + option.Icon + "'></i> <span>" + option.Description + "</span></a>" +
                            "</li>");
            }
        }
    }
